...
//updating the room
import { collection, Timestamp, addDoc, onSnapshot, query, where, orderBy } from "https://www.gstatic.com/firebasejs/10.12.4/firebase-firestore.js";
...
class Chatroom {
  ...
  async addChat(message){
    ...
    getChats(callback){
            ...
            const filter = query(this.chats, where('room', '==', this.room), orderBy('created_at'));
